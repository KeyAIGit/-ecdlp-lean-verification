...
- **small** — the live snapshot: `STATUS.md`,
  ...
  the linked `tasks/ECDLP_LAB_BUILD.md` engineering contract and
  `tasks/ECDLP_LAB_REUSE_INVENTORY.json` frozen-input inventory,
...
- `TASK-015` completed the M16 symbolic desk. `TASK-016` isolated the affine
  ...
  `TASK-018` then froze the recursive projective S17 contract, recorded the
