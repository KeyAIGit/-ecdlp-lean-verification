...
class SpectralRootTransportC39Tests(unittest.TestCase):
    def test_full_replay(self) -> None:
        ...
        self.assertTrue(aggregate["all_dickson_expansions_dense"])
        ...
        for row in payload["curves"]:
            ...
            self.assertEqual(row["dickson_nonzero_coefficients"], r)
            self.assertGreaterEqual(row["coefficient_linear_complexity"], r // 2)
