...
`RH-018`**: apply the re-verification corrections to the Weierstrass contract (queue status: `ACTIVE 2026-08-09 — documentation only; no statement moves`). This is an
