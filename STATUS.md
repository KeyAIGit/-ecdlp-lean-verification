...
`RH-010`**: multiplicity/divisor package promotion after contract acceptance (queue status: `ACTIVE 2026-08-07 — kernel promotion as its own change; the kernel`). This is an
