...
`RH-007`**: independent xi-contract acceptance, then promotion (queue status: `ACTIVE - independent xi-contract acceptance only; built promotion is not authorized`). This is an
