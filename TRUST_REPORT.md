...
**Scope of the verified body.** `266 ledger rows / ~227 distinct kernel-verified
results` (≈39 of the 266 rows are alternate-form or `supporting:` restatements of the
