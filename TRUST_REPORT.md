...
**Scope of the verified body.** `263 ledger rows / ~224 distinct kernel-verified
results` (≈39 of the 263 rows are alternate-form or `supporting:` restatements of the
