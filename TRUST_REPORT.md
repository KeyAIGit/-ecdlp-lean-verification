...
**Scope of the verified body.** `245 ledger rows / ~207 distinct kernel-verified
results` (≈38 of the 245 rows are alternate-form or `supporting:` restatements of the
