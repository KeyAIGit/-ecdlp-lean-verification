...
**Scope of the verified body.** `248 ledger rows / ~209 distinct kernel-verified
results` (≈39 of the 248 rows are alternate-form or `supporting:` restatements of the
