...
**Scope of the verified body.** `223 ledger rows / ~187 distinct kernel-verified
results` (≈36 of the 223 rows are alternate-form or `supporting:` restatements of the
