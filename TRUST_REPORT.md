...
**Scope of the verified body.** `243 ledger rows / ~205 distinct kernel-verified
results` (≈38 of the 243 rows are alternate-form or `supporting:` restatements of the
