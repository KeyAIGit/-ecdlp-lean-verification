...
**Scope of the verified body.** `249 ledger rows / ~210 distinct kernel-verified
results` (≈39 of the 249 rows are alternate-form or `supporting:` restatements of the
