...
**Scope of the verified body.** `227 ledger rows / ~191 distinct kernel-verified
results` (≈36 of the 227 rows are alternate-form or `supporting:` restatements of the
