...
**Scope of the verified body.** `261 ledger rows / ~222 distinct kernel-verified
results` (≈39 of the 261 rows are alternate-form or `supporting:` restatements of the
