...
**Scope of the verified body.** `222 ledger rows / ~186 distinct kernel-verified
results` (≈36 of the 222 rows are alternate-form or `supporting:` restatements of the
