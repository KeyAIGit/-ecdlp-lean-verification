...
**Scope of the verified body.** `264 ledger rows / ~225 distinct kernel-verified
results` (≈39 of the 264 rows are alternate-form or `supporting:` restatements of the
