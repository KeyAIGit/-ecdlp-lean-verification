...
**Scope of the verified body.** `255 ledger rows / ~216 distinct kernel-verified
results` (≈39 of the 255 rows are alternate-form or `supporting:` restatements of the
