...
**Scope of the verified body.** `220 ledger rows / ~184 distinct kernel-verified
results` (≈36 of the 220 rows are alternate-form or `supporting:` restatements of the
