...
**Scope of the verified body.** `218 ledger rows / ~182 distinct kernel-verified
results` (≈36 of the 218 rows are alternate-form or `supporting:` restatements of the
