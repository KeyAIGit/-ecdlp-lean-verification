...
**Scope of the verified body.** `278 ledger rows / ~239 distinct kernel-verified
results` (≈39 of the 278 rows are alternate-form or `supporting:` restatements of the
