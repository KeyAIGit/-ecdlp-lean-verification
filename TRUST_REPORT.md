...
**Scope of the verified body.** `259 ledger rows / ~220 distinct kernel-verified
results` (≈39 of the 259 rows are alternate-form or `supporting:` restatements of the
