...
**Scope of the verified body.** `250 ledger rows / ~211 distinct kernel-verified
results` (≈39 of the 250 rows are alternate-form or `supporting:` restatements of the
