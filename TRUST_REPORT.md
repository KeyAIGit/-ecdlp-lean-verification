...
**Scope of the verified body.** `257 ledger rows / ~218 distinct kernel-verified
results` (≈39 of the 257 rows are alternate-form or `supporting:` restatements of the
