...
**Scope of the verified body.** `225 ledger rows / ~189 distinct kernel-verified
results` (≈36 of the 225 rows are alternate-form or `supporting:` restatements of the
