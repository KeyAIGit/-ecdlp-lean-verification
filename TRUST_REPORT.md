...
**Scope of the verified body.** `254 ledger rows / ~215 distinct kernel-verified
results` (≈39 of the 254 rows are alternate-form or `supporting:` restatements of the
