...
**Scope of the verified body.** `252 ledger rows / ~213 distinct kernel-verified
results` (≈39 of the 252 rows are alternate-form or `supporting:` restatements of the
