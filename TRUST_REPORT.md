...
**Scope of the verified body.** `258 ledger rows / ~219 distinct kernel-verified
results` (≈39 of the 258 rows are alternate-form or `supporting:` restatements of the
