...
**Scope of the verified body.** `224 ledger rows / ~188 distinct kernel-verified
results` (≈36 of the 224 rows are alternate-form or `supporting:` restatements of the
