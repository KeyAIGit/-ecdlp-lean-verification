...
**Scope of the verified body.** `251 ledger rows / ~212 distinct kernel-verified
results` (≈39 of the 251 rows are alternate-form or `supporting:` restatements of the
