...
Canonical figure (single source of truth): "136 ledger rows / ~122 distinct results".
...
CANONICAL_PRESENT = ["~122 distinct", "136 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'136 ledger rows / ~122 distinct results':")
