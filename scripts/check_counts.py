...
Canonical figure (single source of truth): "114 ledger rows / ~105 distinct results".
...
CANONICAL_PRESENT = ["~105 distinct", "114 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'114 ledger rows / ~105 distinct results':")
