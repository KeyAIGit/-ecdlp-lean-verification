...
Canonical figure (single source of truth): "123 ledger rows / ~112 distinct results".
...
CANONICAL_PRESENT = ["~112 distinct", "123 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'123 ledger rows / ~112 distinct results':")
