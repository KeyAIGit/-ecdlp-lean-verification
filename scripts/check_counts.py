...
Canonical figure (single source of truth): "140 ledger rows / ~126 distinct results".
...
CANONICAL_PRESENT = ["~126 distinct", "140 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'140 ledger rows / ~126 distinct results':")
