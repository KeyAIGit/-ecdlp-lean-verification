...
Canonical figure (single source of truth): "135 ledger rows / ~121 distinct results".
...
CANONICAL_PRESENT = ["~121 distinct", "135 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'135 ledger rows / ~121 distinct results':")
