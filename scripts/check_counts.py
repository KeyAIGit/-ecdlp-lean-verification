...
Canonical figure (single source of truth): "118 ledger rows / ~107 distinct results".
...
CANONICAL_PRESENT = ["~107 distinct", "118 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'118 ledger rows / ~107 distinct results':")
