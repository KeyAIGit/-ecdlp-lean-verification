...
Canonical figure (single source of truth): "125 ledger rows / ~114 distinct results".
...
CANONICAL_PRESENT = ["~114 distinct", "125 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'125 ledger rows / ~114 distinct results':")
