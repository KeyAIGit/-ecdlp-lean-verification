...
Canonical figure (single source of truth): "137 ledger rows / ~123 distinct results".
...
CANONICAL_PRESENT = ["~123 distinct", "137 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'137 ledger rows / ~123 distinct results':")
