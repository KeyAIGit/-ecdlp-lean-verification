...
Canonical figure (single source of truth): "120 ledger rows / ~109 distinct results".
...
CANONICAL_PRESENT = ["~109 distinct", "120 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'120 ledger rows / ~109 distinct results':")
