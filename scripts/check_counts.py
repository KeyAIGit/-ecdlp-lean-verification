...
Canonical figure (single source of truth): "134 ledger rows / ~120 distinct results".
...
CANONICAL_PRESENT = ["~120 distinct", "134 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'134 ledger rows / ~120 distinct results':")
