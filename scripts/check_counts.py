...
Canonical figure (single source of truth): "126 ledger rows / ~115 distinct results".
...
CANONICAL_PRESENT = ["~115 distinct", "126 ledger rows"]
...
def main() -> int:
    ...
    if failures:
        print("COUNT CONSISTENCY FAILED — fix these to the canonical figure "
              "'126 ledger rows / ~115 distinct results':")
