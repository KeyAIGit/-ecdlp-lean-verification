...
| N4 | `φₙ := x·ψₙ² − ψₙ₊₁ψₙ₋₁` is monic of degree `n²` | LEAF | ✅ **LANDED** general `n` (`Ecdlp/Proved/DivisionPolynomialGeneralDegree.lean`: `secp256k1_Φ_natDegree`=`n²`, `secp256k1_Φ_monic`, `secp256k1_ΨSq_natDegree`=`n²−1`), instantiating Mathlib `DivisionPolynomial.Degree` — the degree half of N10 |
